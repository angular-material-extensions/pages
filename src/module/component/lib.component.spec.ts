...
describe('LibComponent', function () {
  ...
  it('should have expected <p> text', () => {
    ...
    expect(p.textContent).toEqual('Open source library for angular apps to illustrate custom material pages content with steps (ideal for tutorials and explanation purposes)');
  });
});
